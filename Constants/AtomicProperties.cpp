...
namespace Constants
{
    ...
    const std::string DISSOCIATES_TO =
    {
        "H", // H2 -> 2H
        "D", // D2 -> 2D
        "" , // He -- No dissociation
    ...
    {
        {1312.0 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100} , // H2
        {1312.0 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100 , 1.0e100} , // D2 -- approx
