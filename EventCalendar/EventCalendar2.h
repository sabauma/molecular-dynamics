...
#ifndef __EVENT_CALENDAR2_H__
#define __EVENT_CALENDAR2_H__
...
private:
    ...
    typedef std::pair<std::vector<CalendarNode*, std::vector<CalendarNode*> > Associations;

    std::vector<Associations> ObjectAssociations;  // Entry point for circularly linked lists
